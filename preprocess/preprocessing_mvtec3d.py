...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default= '/media/pami/disk1/3DMMFN/data/mvtec_3d', required=False , help='The root path of the MVTec 3D-AD. The preprocessing is done inplace (i.e. the preprocessed dataset overrides the existing one)')
